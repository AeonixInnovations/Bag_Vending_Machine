...
router.get("/getRefillDetails", stockUpdate_controller_1.getRefillStockDetails);
...
router.get("/getSalesbyWeek", graph_comtrollers_1.getWeeklySales);
router.get("/getDailySales", graph_comtrollers_1.getDailySales);
router.get("/getDeviceWiseSales", graph_comtrollers_1.getDeviceWiseSales);
router.get("/getSalesbyMonthlyWeek", graph_comtrollers_1.getMonthlyWeeklySales);
router.get("/getMonthlyDailySales", graph_comtrollers_1.getMonthlyDailySales);
router.get("/getDevices", deviceSales_1.getDeviceData);
router.get("/getDevicesAdress", graph_comtrollers_1.getDeviceCountByAddress);
